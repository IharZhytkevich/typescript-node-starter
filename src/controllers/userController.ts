...
export class UserController {
   ...
   */
  public async postUpdateProfile(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
   ...
   */
  public postUpdatePassword = async (
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
   ...
   * @route GET /forgot
   */
  public getForgot(req: Request, res: Response): void {
    if (req.isAuthenticated()) {
      return res.redirect("/");
    }
